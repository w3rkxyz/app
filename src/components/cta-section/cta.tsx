...
const CtaSection = () => {
	return (
		<div className="cta-section pt-[248px] sm:pt-20 sm:pb-10 pb-[200px]">
				...
				<div className="cta-wrapper">
					<div className="cta-content-box py-[64px] px-[75px] sm:py-8 sm:px-10 rounded-[30px] bg-white-gray max-w-[643px] mx-auto">
						...
						<p className="text-[18px] sm:text-[16px] text-center font-primary font-semibold leading-[1.3] text-dark">
							Let’s redefine how work gets done in the
							decentralized era!
						</p>
						<ul className="socials-widgets mt-16 flex items-center gap-9 sm:gap-[18px] justify-center">
							<li className="socials-widgets-items">
								<a href="/">
									<Image
										className="w-[50px] sm:w-[30px] h-[50px] sm:h-[30px]"
