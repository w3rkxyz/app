      ...
      <div className="custom-container">
        <div className="section-title-box text-center mb-10">
          <h2 className="section-title text-center">
            Unlock the potential of <span className="text-primary">blockchain</span> technology.
          </h2>
        </div>
        <div className="our-technology-wrapper">
          <div className="our-technology-cards-item sm:flex-col sm:gap-4 flex items-center gap-[14px] max-w-[864px] mx-auto mb-[18px] sm:mb-10">
            ...
            <p className="tech-card-desc text-left sm:text-center">
              Create your Web 3.0 identity effortlessly via Lens where you can showcase your
          ...
          <div className="our-technology-cards-item sm:flex-col sm:gap-4 flex items-center gap-[14px] max-w-[864px] mx-auto mb-[18px] sm:mb-10">
            ...
            <p className="tect-card-desc text-left sm:text-center">
              List your services or post a job directly on the blockchain, creating a strong
              foundation for fruitful collaborations on-chain.
            </p>
          </div>
          <div className="our-technology-cards-item sm:flex-col sm:gap-4 flex items-center gap-[14px] max-w-[864px] mx-auto mb-[18px] sm:mb-10">
            <div className="flex justify-center items-center relative p-[25px] sm:p-[17px]  rounded-[40px] sm:rounded-[20px] bg-[#FFFFFF1A] max-w-[150px] max-h-[150px] sm:max-w-[100px] sm:max-h-[100px] min-w-[150px] min-h-[150px] sm:min-w-[100px] sm:min-h-[100px] top-pick-card-shadow">
            ...
            <p className="tect-card-desc text-left sm:text-center">
              Experience secure and transparent payments, freelancers set their rates and
              organisations pay seamlessly in cryptocurrency.
            </p>
          </div>
          <div className="our-technology-cards-item sm:flex-col sm:gap-4 flex items-center gap-[14px] max-w-[864px] mx-auto">
            ...
            <p className="tect-card-desc text-left sm:text-center">
              We ensure secure escrow services and efficient dispute resolution, benefiting both
              parties. Transactions are protected until obligations are met, fostering trust and
              reliability for all.
            </p>
          </div>
        </div>
