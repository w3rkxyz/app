...
> = ({
  ...
  return (
    <div className="flex w-[900px] sm:w-full  flex-col items-center w-full justify-center px-6  py-4">
      ...
      <div className=" xs:mb-4 mb-8  w-full max-w-[1047px] mx-auto flex  xs:flex-col gap-4 sm:flex-row sm:gap-6">
        <button
          onClick={() => onRoleSelect("client")}
          className={`flex flex-col items-center xs:w-full md:w-[511px] flex-1 rounded-[8px] border bg-white  transition-all hover:border-gray-400 hover:shadow-md ${
