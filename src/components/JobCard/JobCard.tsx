...
const JobCard: React.FC<CardProps> = ({
	...
	return (
		<div
			className={`flex sm:flex-col items-center gap-[29px] h-[132px] md:gap-3 bg-[#FFFFFF] py-[17px] rounded-[20px] sm:h-auto my-[21px] pl-[38px] sm:pl-[16px] pr-[18px]`}
		>
					...
					{userAvatar && username && (
						<div className="items-center pl-2">
							<div className="flex justify-center items-center ">
								<div className="w-[57px] h-[54px] sm:w-[48px] sm:h-[48px] shadow-xl shadow-[#000000]/5 rounded-[10px]">
									<Image
										src={userAvatar}
										alt="User Avatar"
							...
							<p className="text-[12px] sm:text-[14px] sm:font-bold py-1 px-3 sm:px-[6px] bg-white rounded-[10px] shadow-xl shadow-[#000000]/5 font-bold font-secondary leading-[20px] tracking-[-1%]">
								{username}
							</p>
						</div>
					)}
			...
			>
				...
				<div className="sm:flex gap-[8px] overflow-x-auto">
