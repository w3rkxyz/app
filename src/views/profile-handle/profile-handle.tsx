...
export default function Profile({ params }: PageProps) {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="custom-container max-w-[1440px] mx-auto profile-md:px-[80px] profile-sm:px-[20px] sm:p-[0px] sm:pt-[60px] pt-[90px] w-full mb-[40px]">
          ...
          <div className="max-w-[350px] sm:max-w-full min-w-[350px] sm:min-w-0 sm:w-full sm:px-[16px]">
            ...
            {handle === currentUserId && (
              <div className="flex gap-3 mb-4">
                <button
                  className="max-w-fit h-[40px] items-center flex justify-center gap-2 rounded-full bg-[#212121] text-white py-2 px-4 text-[14px] font-medium hover:bg-[#333] transition-colors shrink-0"
                ...
                <button
                  className="max-w-fit flex h-[40px] items-center justify-center gap-2 rounded-full border border-[#212121] text-black py-2 px-4 text-[14px] font-medium hover:bg-[#212121] hover:text-white transition-colors shrink-0"
                  // onClick={handleOpenJobModal}
                >
                  Message
                </button>
