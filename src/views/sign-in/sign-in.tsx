          ...
          <div className="">
            ...
            {familyConnector && (
              <button 
                ...
                className="min-w-[420px] bg-black text-white py-3 rounded-2xl flex items-center justify-center gap-2 font-medium mb-6 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-800 transition"
              >
                <Image
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[#6C6C6C] text-base">
