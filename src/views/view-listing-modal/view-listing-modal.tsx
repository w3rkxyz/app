...
const ViewListingModal = () => {
	return (
		<div className="view-listing-modal-section pt-[184px] pb-10">
			<div className="custom-container mt-7">
				<div className="flex justify-center items-center">
					<div className="w-[1110px] pl-[63px] pr-[78px] modal-shadow py-[47px] sm:py-5 md:py-4 sm:px-5 md:px-5 rounded-[20px] relative">
						<div>
							<Image
								src={closeIcon}
								alt=""
						...
						<div className="view-listing-modal-section flex justify-between">
							<div>
								<div className="w-[250px] flex-shrink-0 sm:h-auto bg-[#FFFFFF]/50 modal-shadow rounded-[20px] py-[26px] px-[25px] md:px-3">
									<div className="flex justify-center items-center">
							...
							<div className="flex-1 pl-[79px] md:px-2 sm:px-0">
								<h2 className="sm:text-[24px] text-[36px] font-secondary font-semibold leading-[80px] tracking-[-4%] ">
									Listing Name
								</h2>
								<div>
						...
						<div className="">
							<div className="flex justify-end sm:justify-center items-center -mt-10 sm:mt-3 md:mr-3 sm:mr-0">
								<MyButton
