		...
		<div className=" sm:bg-transparent">
			<div className="custom-container">
				<div className="flex justify-center items-center">
					<div className="w-[614px] sm:w-full  bg-[#EFEFEF] modal-shadow border-[2px] border-[#000000]/20 sm:border-none rounded-[20px] relative">
						<div className="absolute right-[10px] top-[10px]">
							<button onClick={handleCloseConract}>
								<Image
